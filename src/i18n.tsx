...
export const translations = {
  en: {
    ...
    webhookNotificationsHelp: "Send a JSON payload to a URL whenever a limit warning or cap event occurs.",
    webhookUrlPlaceholder: "https://example.com/webhook",
    webhookSaved: "Webhook URL saved.",
    webhookTestSent: "Test payload sent.",
    test: "Test",
    ...
    autoExport: "Auto-export usage",
    autoExportHelp: "Automatically export a CSV of all usage history to a folder every N days. Set to 0 to disable.",
    selectFolder: "Select folder",
    exportNow: "Export now",
    autoExportSaved: "Auto-export settings saved.",
    autoExportSavedTo: "Exported to {path}",
    logRetention: "Log retention",
    logRetentionHelp: "Automatically delete request logs older than this many days. Set to 0 to keep forever.",
    logRetentionSaved: "Log retention setting saved.",
    cleanupLogsNow: "Clean up old logs now",
    logRetentionCleaned: "Deleted {count} old log rows",
    auditExport: "Audit log export",
    auditExportHelp: "Export recorded security and configuration events. 0 days = all events.",
    auditExportSaved: "Audit log saved to {path}",
  ...
  "zh-CN": {
    ...
    webhookNotificationsHelp: "当限额警告或上限事件发生时，向指定 URL 发送 JSON 载荷。",
    webhookUrlPlaceholder: "https://example.com/webhook",
    webhookSaved: "Webhook URL 已保存。",
    webhookTestSent: "测试载荷已发送。",
    test: "测试",
    autoStart: "自动启动",
    ...
    autoExport: "自动导出用量",
    autoExportHelp: "每隔 N 天自动将所有用量历史导出为 CSV 到指定文件夹。设为 0 则禁用。",
    selectFolder: "选择文件夹",
    exportNow: "立即导出",
    autoExportSaved: "自动导出设置已保存。",
    autoExportSavedTo: "已导出到 {path}",
    logRetention: "日志保留",
    logRetentionHelp: "自动删除超过此天数的历史请求日志。设为 0 则永久保留。",
    logRetentionSaved: "日志保留设置已保存。",
    cleanupLogsNow: "立即清理旧日志",
    logRetentionCleaned: "已删除 {count} 条旧日志",
    auditExport: "审计日志导出",
    auditExportHelp: "导出记录的安全与配置事件。0 天 = 所有事件。",
    auditExportSaved: "审计日志已保存到 {path}",
