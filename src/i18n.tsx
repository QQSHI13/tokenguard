...
export const translations = {
  en: {
    ...
    bannerFreeFeatureHistory: "Free edition: 7-day request history",
    bannerFreeFeatureUpdates: "Free edition: manual updates",
    bannerLicensedFeatureUnlimited: "Licensed: unlimited history + 2 devices",
    bannerLicensedFeatureUpdates: "Licensed: auto-updates",
  ...
  "zh-CN": {
    ...
    learnMore: "了解更多",
    bannerFreeFeatureHistory: "免费版：7 天请求历史",
    bannerFreeFeatureUpdates: "免费版：手动更新",
    bannerLicensedFeatureUnlimited: "授权版：无限历史 + 2 台设备",
    bannerLicensedFeatureUpdates: "授权版：自动更新",
